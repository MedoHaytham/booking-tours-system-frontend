    ...
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-6">
        <button
          type="submit"
          disabled={loading}
          className="bg-primary text-white uppercase flex-1 w-full text-base rounded-full px-12 py-4 transition-transform hover:-translate-y-0.5 disabled:opacity-60 cursor-pointer"
        >
