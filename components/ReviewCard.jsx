...
export default function ReviewCard({ review, hideUser, myReview, className = 'w-84 md:w-150 shrink-0' }) {
      ...
      {review.tour && myReview && (
        <div className='w-full flex justify-between'>
          <Link
            ...
            className="max-w-51 lg:max-w-58.75 xl:max-w-70 truncate self-start mb-4 text-primary font-semibold text-[1.3rem] hover:underline transition-colors duration-200"
          >
            {review.tour.name}
          </Link>
